...
// This problem below is really lame.
unsigned long int largest_product_in_a_grid(unsigned short int num) {
	int array [20][20]  {
	...
	std::cout << starting_num << "\n";
	return largest_product;
}


int main() {
	std::cout << largest_product_in_a_grid(4) << "\n";
}
